...
<body class="bg-background text-on-surface font-sans antialiased min-h-screen flex flex-col">
  ...
  <section class="py-12 md:py-16 bg-gradient-to-b from-[#e5eeff]/40 to-transparent">
    <div class="max-w-[1280px] mx-auto px-4 md:px-6 text-center">
      <span class="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-semibold bg-primary/10 text-primary mb-4">
      ...
      <p class="text-sm md:text-base text-slate-500 max-w-2xl mx-auto leading-relaxed">
        Tra cứu nhanh mã số thuế, người đại diện, địa chỉ và ngành nghề kinh doanh của hàng triệu doanh nghiệp trên toàn quốc.
      </p>
    </div>
  </section>
    ...
    <form method="GET" action="index.php" class="bg-white rounded-xl shadow-sm border border-slate-100 p-5 mb-6">
      ...
      <div class="flex flex-col md:flex-row gap-4 items-end">
        <div class="w-full md:w-3/4 flex flex-col">
          ...
          <input type="text" name="search" class="w-full text-sm h-[31px] px-3 rounded-lg border border-slate-200 focus:border-primary focus:ring-2 focus:ring-primary/20 transition duration-150 outline-none" 
        ...
        <div class="w-full md:w-1/4 flex gap-2 justify-end">
          <a href="index.php" class="px-4 py-1.5 text-sm font-semibold rounded-lg border border-slate-200 text-slate-600 hover:bg-slate-50 transition duration-150 flex-1 text-center">
            Xoá lọc
          </a>
          <button type="submit" class="px-5 py-1.5 text-sm font-semibold rounded-lg bg-primary hover:bg-primary-container text-white transition duration-150 flex-1">
            Lọc
          </button>
        </div>
      </div>
          ...
          <tbody class="divide-y divide-slate-100">
            ...
            <tr class="hover:bg-slate-50/40 transition duration-150">
              ...
              <td class="px-4 py-3.5">
                <a href="chi-tiet.php?mst=<?= urlencode($dn['mst']) ?>" class="font-semibold text-primary hover:underline hover:text-primary-container transition duration-150 block text-sm">
                  <?= e($dn['ten_cong_ty']) ?>
                </a>
              </td>
              <td class="px-4 py-3.5">
                <span class="inline-block px-2 py-0.5 rounded bg-slate-50 border border-slate-200 text-xs font-mono font-semibold text-slate-600 tracking-tight">
                  <?= e($dn['mst']) ?>
                </span>
              </td>
              ...
              <td class="px-4 py-3.5">
                ...
                ?>
                <span class="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-semibold border <?= $badgeStyle ?>">
                  <?= e($ts ?: 'Chưa rõ') ?>
                </span>
              </td>
              <td class="px-4 py-3.5 text-right">
                <a href="chi-tiet.php?mst=<?= urlencode($dn['mst']) ?>" class="inline-flex items-center justify-center px-3 py-1 rounded-md text-xs font-semibold border border-primary/20 text-primary hover:bg-primary hover:text-white transition duration-150">
                  Chi tiết
                </a>
              </td>
            </tr>
